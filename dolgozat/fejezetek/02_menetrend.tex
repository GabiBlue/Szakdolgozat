...
Végezetül tekintsük át a Budapesti Közlekedési Központ Zrt. Menetrendek oldalát \cite{bkk}. Egy könnyen kezelhető, letisztult felületen lehet böngészni a menetrendet és útvonalat tervezni is. Ez látható \aref{fig:bkk_menetrend}. ábrán. A felület tetején egy gombsor található, amely segítségével a különböző típusokra szűrhetünk, mint például autóbusz, villamos, metró, hév stb.
