...
Az eredményt egy listában adja vissza, amely a megállók neveit tartalmazza. A \texttt{cost} értéke pedig 780 ebben a példában.
...
Az átalakítás után, az előző példánál maradva, ha kipróbáljuk az Egyetemváros és a Selyemrét megállókkal az algoritmust, akkor a \texttt{path} eredménye a következő lesz:
...
Az eredményt szintén egy listában adja vissza, azonban a listában most már nem csak pusztán a megállók nevei vannak, hanem dictionary-kben név és viszonylat kulcs-érték párok.
